    ...
    <main>
        ...
        <section>
            ...
            <div class="title">
                ...
                <div class="btns_hover aa">작성</div>
            </div>
            <div class="title_box">
...
/*         submits();
        ...
        function hashs(){
        	let hashs = document.querySelectorAll(".hashtags")
        	let strArr = "";
        	console.log("aa")
        	for(let i = 0 ; i<hashs.length ;i++){
        		console.log(hashs[i].textContent)
        		strArr += ""+hashs[i].innerText.substring(1)+",";
        	}
        	window.location.href = "DDDD?gdt="+strArr
        	console.log(strArr)
        } */
        file_add()
		function file_add(){
