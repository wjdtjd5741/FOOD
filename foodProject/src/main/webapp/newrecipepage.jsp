...
<body>
	<main>
		<nav>
			<div class="mobile_console">
				<div class="array_console">
					...
					<%-- <img src="https://media.discordapp.net/attachments/1123448023238844436/1149245362893246494/home.png">
                          --%>
						<div class="home">홈</div>
					</a> <a href="bulletin.html"> <img
						src="https://media.discordapp.net/attachments/1123448023238844436/1149245362603819048/category.png">
						<div class="category">카테고리</div>
					</a> <a href="recipepage.html"> <img
		...
		<section>
			...
			<div class="title_box">
				<textarea type="text" class="recipick_title" value="레시피 제목을 작성해주세요"
